    ...
    if (existingUsers.length === 0) {
      ...
      if (existingPosts.length === 0) {
        const posts = await Post.insertMany([
          ...
          { author: users[0]._id, date: new Date('2024-04-31T00:00:00.000Z'), header: 'The Cookie Dough Dilemma - To Chill or Not to Chill?',
        ...
        if (existingComments.length === 0) {
          const comments = await Comment.insertMany([
            { author: users[1]._id, date: new Date('2024-10-18T00:00:00.000Z'), 
